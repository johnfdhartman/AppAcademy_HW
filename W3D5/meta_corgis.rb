...
class MetaCorgiSnacks
  ...
  #   info = @snack_box.send("get_#{method_name}_info".to_sym, *args)
  #   tastiness = @snack_box.send("get_#{method_name}_tastiness".to_sym, *args)
  ...
  def self.define_snack(name)
    define_method(name.to_sym) do |box_id|
      info = @snack_box.send("get_#{name}_info".to_sym, *args)
      tastiness = @snack_box.send("get_#{name}_tastiness".to_sym, *args)
